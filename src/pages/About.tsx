          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-slate-700 leading-relaxed">
                To provide a stimulating learning environment that fosters
                academic excellence, moral integrity, and social responsibility,
                empowering every child to become a confident and compassionate
            ...
            >
              ...
              <p className="text-slate-700 leading-relaxed">
                To be a premier institution recognized for nurturing
                well-rounded individuals who are equipped with the knowledge,
                skills, and values to positively impact their communities and
                the world at large.
              </p>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {["Excellence", "Integrity", "Discipline", "Creativity"].map(
              (value, idx) => (
                <motion.div
                  key={value}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12 bg-white rounded-3xl shadow-xl shadow-navy-900/5 overflow-hidden border border-slate-100">
            <div className="md:w-1/3 h-64 md:h-auto bg-slate-200 relative">
              <img
                src="https://lh3.googleusercontent.com/d/1G-62GDigHiWD4KerRaJev96-QNOxzFTJ"
                alt="Proprietor"
                loading="lazy"
                decoding="async"
            ...
            <div className="md:w-2/3 p-8 md:p-12">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed italic">
                "Welcome to Uyo Golden City Academy. We are dedicated to
                providing a supportive and condusive environment where every
                pupil can thrive. Our commitment to excellence extends beyond
                the classroom, as we strive to mold character and instill values
                that will last a lifetime."
              </p>
              <div>
                <p className="font-bold text-navy-900">Captain Victor Ndueso</p>
                <p className="text-sm text-gold-600 font-medium uppercase tracking-wider">
                  Proprietor
                </p>
              </div>
            </div>
