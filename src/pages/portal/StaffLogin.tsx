  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.user.role === 'super-admin') navigate('/portal/super-admin');
        else if (data.user.role === 'admin') navigate('/portal/admin');
        else if (data.user.role === 'teacher') navigate('/portal/teacher');
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="bg-navy-900 p-8 text-center relative">
          ...
          <h1 className="text-2xl font-serif font-bold text-white mb-2">Staff Login</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-transparent outline-none transition-all"
